        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              >
                <Button size="lg" className="bg-[#1E2E48] hover:bg-[#1E2E48]/80 text-white w-full md:w-auto transition-colors">
                  <Search className="mr-2 h-4 w-4" />
                  Search Ferries
                </Button>
              </a>
              <span className="text-xs text-gray-600 font-medium">FerryScanner.com</span>
            </div>
          </div>
        </div>
      </div>
